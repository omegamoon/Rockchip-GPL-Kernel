...
#if defined(CONFIG_BOX_FB_480P)
#define HDMI_VIDEO_DEFAULT_MODE		HDMI_720x480p_60Hz
#else
// If none of the 'BOX' resolutions are configured assume 720p
#define HDMI_VIDEO_DEFAULT_MODE			HDMI_1280x720p_60Hz
#endif // CONFIG_BOX_FB_480P
#endif // CONFIG_BOX_FB_1080P
#endif // CONFIG_BOX_FB_720P

#else
// Omegamoon >> default Rockchip behavior
...
#if defined(CONFIG_AUTO_VIDEO_MODE_HANDLING)
...
{
	HDMI_AUDIO_NLPCM = 0,  // Omegamoon >> added
	HDMI_AUDIO_LPCM = 1,
	HDMI_AUDIO_AC3,
	HDMI_AUDIO_MPEG1,
	HDMI_AUDIO_MP3,
